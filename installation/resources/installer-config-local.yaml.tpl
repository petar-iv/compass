...
data:
  ...
  global.tenantFetchers.account-fetcher.isOAuthEnabled: "true"
  ...
  global.tenantFetchers.account-fetcher.shouldSyncCustomers: "false"
  ...
  global.tenantFetchers.subaccount-fetcher.isOAuthEnabled: "true"
  ...
  global.tenantFetchers.subaccount-fetcher.shouldSyncCustomers: "false"
  ...
  global.tenantFetchers.customer-fetcher.cron.enabled: "false"
  global.tenantFetchers.customer-fetcher.enabled: "true"
  global.tenantFetchers.customer-fetcher.job.interval: "10s"
  global.tenantFetchers.customer-fetcher.dbPool.maxOpenConnections: "1"
  global.tenantFetchers.customer-fetcher.dbPool.maxIdleConnections: "1"
  global.tenantFetchers.customer-fetcher.manageSecrets: "false"
  global.tenantFetchers.customer-fetcher.isOAuthEnabled: "false"
  global.tenantFetchers.customer-fetcher.providerName: "icp"
  global.tenantFetchers.customer-fetcher.schedule: "0 23 * * *"
  global.tenantFetchers.customer-fetcher.kubernetes.configMapNamespace: "compass-system"
  global.tenantFetchers.customer-fetcher.kubernetes.pollInterval: "2s"
  global.tenantFetchers.customer-fetcher.kubernetes.pollTimeout: "1m"
  global.tenantFetchers.customer-fetcher.kubernetes.timeout: "2m"
  global.tenantFetchers.customer-fetcher.shouldSyncSubaccounts: "false"
  global.tenantFetchers.customer-fetcher.shouldSyncCustomers: "true"

  global.tenantFetchers.customer-fetcher.entitlementsProvider.tokenURL: "https://entitlements-provider.com/getToken"
  global.tenantFetchers.customer-fetcher.entitlementsProvider.entitlementsURL: "https://entitlements-provider.com/entitlements"
  global.tenantFetchers.customer-fetcher.entitlementsProvider.secretName: "icp-credentials"
  global.tenantFetchers.customer-fetcher.entitlementsProvider.secretPath: "auth"

  global.tenantFetchers.customer-fetcher.fieldMapping.idField: ""
  global.tenantFetchers.customer-fetcher.query.startPage: ""
  global.tenantFetchers.customer-fetcher.query.pageSize: ""
  global.tenantFetchers.customer-fetcher.endpoints.accountCreated: ""
  global.tenantFetchers.customer-fetcher.queryMapping.pageNumField: ""
---
apiVersion: v1
kind: ConfigMap
metadata:
