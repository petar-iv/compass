...
var tableColumns = []string{"id", tenantColumn, "app_id", "runtime_id", "runtime_context_id", "solution_id", "key", "value"}
...
func NewRepository(conv Converter) *repository {
	return &repository{
		upserter: repo.NewUpserter(resource.Label, tableName, tableColumns, []string{tenantColumn, "coalesce(app_id, '00000000-0000-0000-0000-000000000000')", "coalesce(runtime_id, '00000000-0000-0000-0000-000000000000')", "coalesce(runtime_context_id, '00000000-0000-0000-0000-000000000000')", "coalesce(solution_id, '00000000-0000-0000-0000-000000000000')", "key"}, []string{"value"}),
...
func labelableObjectField(objectType model.LabelableObject) string {
	...
	case model.SolutionLabelableObject:
		return "solution_id"
	}
