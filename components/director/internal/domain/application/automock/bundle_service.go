...
// ListByApplicationIDsForScenarios provides a mock function with given fields: ctx, applicationIDs, scenarios, pageSize, cursor
func (_m *BundleService) ListByApplicationIDsForScenarios(ctx context.Context, applicationIDs []string, scenarios []string, pageSize int, cursor string) ([]*model.BundlePage, error) {
	ret := _m.Called(ctx, applicationIDs, scenarios, pageSize, cursor)

	var r0 []*model.BundlePage
	if rf, ok := ret.Get(0).(func(context.Context, []string, []string, int, string) []*model.BundlePage); ok {
		r0 = rf(ctx, applicationIDs, scenarios, pageSize, cursor)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.BundlePage)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, []string, int, string) error); ok {
		r1 = rf(ctx, applicationIDs, scenarios, pageSize, cursor)
	} else {
		r1 = ret.Error(1)
	}
...
// ListByApplicationIDsForScenariosNoPaging provides a mock function with given fields: ctx, applicationIDs, scenarios
func (_m *BundleService) ListByApplicationIDsForScenariosNoPaging(ctx context.Context, applicationIDs []string, scenarios []string) ([]*model.Bundle, error) {
	ret := _m.Called(ctx, applicationIDs, scenarios)

	var r0 []*model.Bundle
	if rf, ok := ret.Get(0).(func(context.Context, []string, []string) []*model.Bundle); ok {
		r0 = rf(ctx, applicationIDs, scenarios)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.Bundle)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, []string, []string) error); ok {
		r1 = rf(ctx, applicationIDs, scenarios)
	} else {
		r1 = ret.Error(1)
	}
