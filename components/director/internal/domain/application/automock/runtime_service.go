...
// ListScenarios provides a mock function with given fields: ctx, runtimeID
func (_m *RuntimeService) ListScenarios(ctx context.Context, runtimeID string) ([]string, error) {
