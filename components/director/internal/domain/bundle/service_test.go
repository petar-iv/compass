...
func TestService_Create(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			...
			svc := bundle.NewService(repo, apiSvc, eventSvc, documentSvc, nil, nil, uidService)
	...
	t.Run("Error when tenant not in context", func(t *testing.T) {
		svc := bundle.NewService(nil, nil, nil, nil, nil, nil, nil)
		// WHEN
...
func TestService_Update(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			...
			svc := bundle.NewService(repo, nil, nil, nil, nil, nil, nil)
...
func TestService_Exist(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			...
			svc := bundle.NewService(bndlRepo, nil, nil, nil, nil, nil, nil)
