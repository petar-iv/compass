...
const (
	...
	SolutionLabelableObject       LabelableObject = "Solution"
)
...
func NewLabelForSolution(solution Solution, key string, value interface{}) *Label {
	return &Label{
		ID:         uuid.New().String(),
		Tenant:     solution.Tenant,
		ObjectType: SolutionLabelableObject,
