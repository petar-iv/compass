...
func ExternalCertIssuerSubjectMatcher(cfg Config) func(subject string) bool {
	externalSubjectConsts := cfg.ExternalIssuerSubject
...
func ConnectorCertificateSubjectMatcher(cfg Config) func(subject string) bool {
	CSRSubjectConsts := cfg.CSRSubject
	return func(subject string) bool {
